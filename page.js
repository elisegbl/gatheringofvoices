...
function SuggestionList({ items, onSelect, formatItem }) {
  return (
    <ul className="mb-4 bg-white shadow-md rounded-lg border p-4 max-h-48 overflow-auto">
...
export default function Home() {
  ...
  // Suggestions for authors and tags
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-pink-50 py-12 px-4">
      <div className="w-full max-w-3xl p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="mb-6 p-6 rounded-xl bg-pink-700 text-white text-center font-bold text-2xl leading-snug">
          ...
          together illuminating our hearts'<br />
          ...
          <div className="inline-block group">
            ...
            <div
              className="
                absolute z-10 w-80 text-sm font-normal text-left p-4 bg-white text-pink-800 rounded-lg shadow-lg
                opacity-0
                pointer-events-none
              ...
              "
            >
              on the surface, this is a growing database of poems and prose i’ve collected over the years!<br /><br />
        ...
        {!loading && filteredQuotes.length === 0 && (
          <p className="text-center text-pink-700 mt-6">No quotes found.</p>
        )}
        <div className="flex flex-col gap-6 mt-6 font-dm-sans">
